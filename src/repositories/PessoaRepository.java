...
//classe para realizar tarefas em banco de dados relacionados a pessoas.
public class PessoaRepository {
	// metodo para inserir pessoa no banco de dados
	public void create(Pessoa pessoa) throws Exception {
		Connection connection = ConnectionFactory.openConnection();
		PreparedStatement preparedStatement = connection
				.prepareStatement("insert into pessoa(nome, email, cpf) values(?,?,?)");
	...
	// metodo para excluir pessoa no banco de dados
	...
	// metodo para consultar pessoa no banco de dados
